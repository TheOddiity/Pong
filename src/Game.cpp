...
Game::Game(const sf::Vector2i& windowSize)
    : m_ball{Ball(windowSize, Game::randSpeedVector())},
...
bool Game::update(float dt)
{
	...
	if (m_pointsRight >= m_winningScore || m_pointsLeft >= m_winningScore)
	{
		gameOver();
	}
...
sf::Vector2f Game::randSpeedVector()
{
