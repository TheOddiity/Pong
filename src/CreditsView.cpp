					...
					m_right{"Odd \"TheOddity\" Restad"	, "Odd \"TheOddity\" Restad", "", "Odd \"TheOddity\" Restad", "Odd \"TheOddity\" Restad"} 	
{
	...
	{
		std::cout << "Error loading CreditsView::Logo" << std::endl;
	}
	...
	{
		std::cout << "Error loading CreditsView::SFMLLogo";
	}
...
bool CreditsView::update()
{
	return hasFocus && sfex::anyKeyPressed();
}

void CreditsView::draw(sf::RenderTarget& target, sf::RenderStates states) const
{	
